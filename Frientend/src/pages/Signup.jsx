  ...
  return (
    <div className="row justify-content-center bg-secondary p-5">
      <div className="col-md-6">
        <h3 className='fs-2 fw-bold'>Signup</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label className="form-label fs-5 fw-bold">Name</label>
          ...
          <div className="mb-3">
            <label className="form-label fs-5 fw-bold">Phone (optional)</label>
          ...
          <div className="d-flex gap-2">
            ...
            <button type="button" className="btn btn-primary" onClick={()=>{ setName(''); setEmail(''); setPassword(''); setPhone('') }} disabled={loading}>Clear</button>
          </div>
        </form>
      </div>
    </div>
