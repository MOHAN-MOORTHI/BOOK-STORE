    ...
    <div className="row bg-secondary p-4">
      ...
      <div className="col-md-8">
        ...
        <form onSubmit={handleSave} encType="multipart/form-data">
          ...
          <div className="mb-3">
            <label className="form-label fs-5 fw-bold">Phone</label>
            <input className="form-control" value={phone} onChange={e=>setPhone(e.target.value)} />
          </div>

          <div className="mb-3">
            <label className="form-label fs-5 fw-bold">Upload Avatar</label>
            <input type="file" accept="image/*" className="form-control" onChange={e=>setFile(e.target.files[0])} />
          </div>

          <button type="submit" className="btn btn-primary fs-5 fw-bold">Save</button>
        </form>
      </div>
    </div>
  )
